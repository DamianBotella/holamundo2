-- 056b: Fix idempotente para 056_studio_layout_v7
-- Damian ejecuto 056 pero el INSERT en applied_migrations choco con PK duplicado
-- (migration ya registrada). Este script:
--   1. Diagnostica el estado actual (rooms y agents)
--   2. Aplica solo lo que falta (idempotente, sin tocar applied_migrations)

-- ============================================================
-- DIAGNOSTICO inicial
-- ============================================================
SELECT
  (SELECT COUNT(*) FROM studio_rooms)   AS rooms_before,
  (SELECT COUNT(*) FROM agents_catalog) AS agents_before;

BEGIN;

-- ============================================================
-- 1. Anadir columna floor_color (idempotente con IF NOT EXISTS)
-- ============================================================
ALTER TABLE studio_rooms ADD COLUMN IF NOT EXISTS floor_color text;

-- ============================================================
-- 2. Reescribir studio_rooms (limpia + reinserta layout v7)
-- ============================================================
...
-- ============================================================
-- 3. Reescribir agents_catalog (limpia + reinserta layout v7)
-- ============================================================
...
-- ============================================================
-- VERIFICACION final (esperado: 10 rooms, 35 agents)
-- ============================================================
SELECT
  (SELECT COUNT(*) FROM studio_rooms)   AS rooms_after,
  (SELECT COUNT(*) FROM agents_catalog) AS agents_after;
